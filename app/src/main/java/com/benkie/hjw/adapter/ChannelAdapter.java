    ...
    protected void convert(final BaseViewHolder baseViewHolder, final Channel channel) {
        switch (baseViewHolder.getItemViewType()) {
            case Channel.TYPE_MY:
                ...
                baseViewHolder.setText(R.id.tvTitle, channel.Title)
                        .setOnClickListener(R.id.tvEdit, new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (!mIsEdit) {
                                    startEditMode(true);
                                    baseViewHolder.setText(R.id.tvEdit, "");
                ...
                baseViewHolder.setText(R.id.tvHint, "点击移除我喜欢的")
            ...
            case Channel.TYPE_OTHER:
                ...
                baseViewHolder.setText(R.id.tvTitle, channel.Title)
                        .setVisible(R.id.tvEdit, false);
                baseViewHolder.setText(R.id.tvHint, "点击添加到“我喜欢的”")
                        .setVisible(R.id.tvEdit, false);
                break;
            case Channel.TYPE_MY_CHANNEL:
                ...
                baseViewHolder.setOnLongClickListener(R.id.rlItemView, new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        if (!mIsEdit) {
                            //开启编辑模式
                            startEditMode(true);
                            mEditViewHolder.setText(R.id.tvEdit, "");
                ...
                baseViewHolder.setOnTouchListener(R.id.tvChannel, new View.OnTouchListener() {
                    @Override
                ...
                baseViewHolder.getView(R.id.ivDelete).setTag(true);//在我的频道里面设置true标示，之后会根据这个标示来判断编辑模式是否显示
                baseViewHolder.setText(R.id.tvChannel, channel.Title).setOnClickListener(R.id.tvChannel, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        if (!mIsEdit && onClickListener != null) {
                            onClickListener.onClick(baseViewHolder.getView(R.id.tvChannel));
                        }
                    }
                });
...
//                            GlobalParams.mRemovedChannels.add(channel);
                       //    }
//                        else if (!mIsEdit && onClickListener != null){
//                            onClickListener.onClick(baseViewHolder.getView(R.id.tvChannel));
//                        }
                    }
                };
                baseViewHolder.setOnClickListener(R.id.ivDelete, clickListener);
                baseViewHolder.setOnClickListener(R.id.tvChannel, clickListener);
                break;
...
//                                GlobalParams.mRemovedChannels.remove(channel);
    ...
    public List<Channel> getMyChannel() {
        ...
        for (int i = 0; i < mData.size(); i++) {
            Channel channel = (Channel) mData.get(i);
            if (channel.getItemType() == Channel.TYPE_MY_CHANNEL&&!channel.Title.equals("推荐")) {
                list.add(channel);
            }
        }
        return list;
